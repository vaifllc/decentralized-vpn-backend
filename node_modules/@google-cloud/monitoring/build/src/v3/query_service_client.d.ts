...
export declare class QueryServiceClient {
    ...
    queryTimeSeries(request: protos.google.monitoring.v3.IQueryTimeSeriesRequest, callback: PaginationCallback<protos.google.monitoring.v3.IQueryTimeSeriesRequest, protos.google.monitoring.v3.IQueryTimeSeriesResponse | null | undefined, protos.google.monitoring.v3.ITimeSeriesData>): void;
    /**
     ...
     */
    queryTimeSeriesStream(request?: protos.google.monitoring.v3.IQueryTimeSeriesRequest, options?: CallOptions): Transform;
    /**
     ...
     * }
     */
    queryTimeSeriesAsync(request?: protos.google.monitoring.v3.IQueryTimeSeriesRequest, options?: CallOptions): AsyncIterable<protos.google.monitoring.v3.ITimeSeriesData>;
    /**
