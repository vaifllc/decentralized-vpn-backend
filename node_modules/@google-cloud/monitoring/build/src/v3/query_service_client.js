 ...
 */
const gapicConfig = require("./query_service_client_config.json");
...
class QueryServiceClient {
    ...
    constructor(opts) {
        ...
        this.descriptors.page = {
            queryTimeSeries: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'timeSeriesData'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.monitoring.v3.QueryService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.queryServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.monitoring.v3.QueryService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.monitoring.v3.QueryService, this._opts);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const queryServiceStubMethods = ['queryTimeSeries'];
        for (const methodName of queryServiceStubMethods) {
            const callPromise = this.queryServiceStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    queryTimeSeries(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
     ...
     *   for more details and examples.
     */
    queryTimeSeriesStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        this.initialize();
        return this.descriptors.page.queryTimeSeries.createStream(this.innerApiCalls.queryTimeSeries, request, callSettings);
    }
    /**
     ...
     * }
     */
    queryTimeSeriesAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this.descriptors.page.queryTimeSeries.asyncIterate(this.innerApiCalls['queryTimeSeries'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
//# sourceMappingURL=query_service_client.js.map