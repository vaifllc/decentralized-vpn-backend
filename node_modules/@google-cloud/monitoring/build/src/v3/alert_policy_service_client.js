...
exports.AlertPolicyServiceClient = void 0;
/* global window */
...
class AlertPolicyServiceClient {
    ...
    constructor(opts) {
        ...
        this.descriptors.page = {
            listAlertPolicies: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'alertPolicies'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.monitoring.v3.AlertPolicyService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.alertPolicyServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.monitoring.v3.AlertPolicyService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.monitoring.v3.AlertPolicyService, this._opts);
        ...
        for (const methodName of alertPolicyServiceStubMethods) {
            const callPromise = this.alertPolicyServiceStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    getAlertPolicy(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
     ...
     */
    createAlertPolicy(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    deleteAlertPolicy(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    updateAlertPolicy(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   for more details and examples.
     */
    listAlertPolicies(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listAlertPoliciesStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listAlertPolicies.createStream(this.innerApiCalls.listAlertPolicies, request, callSettings);
    }
    /**
    ...
    listAlertPoliciesAsync(request, options) {
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this.descriptors.page.listAlertPolicies.asyncIterate(this.innerApiCalls['listAlertPolicies'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.AlertPolicyServiceClient = AlertPolicyServiceClient;
//# sourceMappingURL=alert_policy_service_client.js.map