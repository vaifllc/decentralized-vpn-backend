...
exports.NotificationChannelServiceClient = void 0;
/* global window */
...
class NotificationChannelServiceClient {
    ...
    constructor(opts) {
        ...
        this.descriptors.page = {
            listNotificationChannelDescriptors: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'channelDescriptors'),
            listNotificationChannels: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'notificationChannels'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.monitoring.v3.NotificationChannelService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.notificationChannelServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.monitoring.v3.NotificationChannelService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.monitoring.v3.NotificationChannelService, this._opts);
        ...
        for (const methodName of notificationChannelServiceStubMethods) {
            const callPromise = this.notificationChannelServiceStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    getNotificationChannelDescriptor(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
     ...
     */
    getNotificationChannel(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    createNotificationChannel(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    updateNotificationChannel(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    deleteNotificationChannel(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    sendNotificationChannelVerificationCode(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    getNotificationChannelVerificationCode(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    verifyNotificationChannel(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   for more details and examples.
     */
    listNotificationChannelDescriptors(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listNotificationChannelDescriptorsStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listNotificationChannelDescriptors.createStream(this.innerApiCalls.listNotificationChannelDescriptors, request, callSettings);
    }
    /**
    ...
    listNotificationChannelDescriptorsAsync(request, options) {
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this.descriptors.page.listNotificationChannelDescriptors.asyncIterate(this.innerApiCalls['listNotificationChannelDescriptors'], request, callSettings);
    }
    /**
     ...
     *   for more details and examples.
     */
    listNotificationChannels(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listNotificationChannelsStream(request, options) {
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this.descriptors.page.listNotificationChannels.createStream(this.innerApiCalls.listNotificationChannels, request, callSettings);
    }
    /**
    ...
    listNotificationChannelsAsync(request, options) {
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this.descriptors.page.listNotificationChannels.asyncIterate(this.innerApiCalls['listNotificationChannels'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.NotificationChannelServiceClient = NotificationChannelServiceClient;
//# sourceMappingURL=notification_channel_service_client.js.map