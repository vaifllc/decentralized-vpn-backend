...
exports.UptimeCheckServiceClient = void 0;
/* global window */
...
class UptimeCheckServiceClient {
    ...
    constructor(opts) {
        ...
        this.descriptors.page = {
            listUptimeCheckConfigs: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'uptimeCheckConfigs'),
            listUptimeCheckIps: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'uptimeCheckIps'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.monitoring.v3.UptimeCheckService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.uptimeCheckServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.monitoring.v3.UptimeCheckService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.monitoring.v3.UptimeCheckService, this._opts);
        ...
        for (const methodName of uptimeCheckServiceStubMethods) {
            const callPromise = this.uptimeCheckServiceStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    getUptimeCheckConfig(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
     ...
     */
    createUptimeCheckConfig(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    updateUptimeCheckConfig(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    deleteUptimeCheckConfig(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   for more details and examples.
     */
    listUptimeCheckConfigs(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listUptimeCheckConfigsStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listUptimeCheckConfigs.createStream(this.innerApiCalls.listUptimeCheckConfigs, request, callSettings);
    }
    /**
    ...
    listUptimeCheckConfigsAsync(request, options) {
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this.descriptors.page.listUptimeCheckConfigs.asyncIterate(this.innerApiCalls['listUptimeCheckConfigs'], request, callSettings);
    }
    /**
     ...
     *   for more details and examples.
     */
    listUptimeCheckIps(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listUptimeCheckIpsStream(request, options) {
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this.descriptors.page.listUptimeCheckIps.createStream(this.innerApiCalls.listUptimeCheckIps, request, callSettings);
    }
    /**
    ...
    listUptimeCheckIpsAsync(request, options) {
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this.descriptors.page.listUptimeCheckIps.asyncIterate(this.innerApiCalls['listUptimeCheckIps'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
//# sourceMappingURL=uptime_check_service_client.js.map