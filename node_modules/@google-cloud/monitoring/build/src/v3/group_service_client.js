 ...
 */
const gapicConfig = require("./group_service_client_config.json");
...
class GroupServiceClient {
    ...
    constructor(opts) {
        ...
        this.descriptors.page = {
            listGroups: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'group'),
            listGroupMembers: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'members'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.monitoring.v3.GroupService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.groupServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.monitoring.v3.GroupService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.monitoring.v3.GroupService, this._opts);
        ...
        for (const methodName of groupServiceStubMethods) {
            const callPromise = this.groupServiceStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    getGroup(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
     ...
     */
    createGroup(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    updateGroup(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    deleteGroup(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   for more details and examples.
     */
    listGroups(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listGroupsStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listGroups.createStream(this.innerApiCalls.listGroups, request, callSettings);
    }
    /**
    ...
    listGroupsAsync(request, options) {
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this.descriptors.page.listGroups.asyncIterate(this.innerApiCalls['listGroups'], request, callSettings);
    }
    /**
     ...
     *   for more details and examples.
     */
    listGroupMembers(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listGroupMembersStream(request, options) {
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this.descriptors.page.listGroupMembers.createStream(this.innerApiCalls.listGroupMembers, request, callSettings);
    }
    /**
    ...
    listGroupMembersAsync(request, options) {
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this.descriptors.page.listGroupMembers.asyncIterate(this.innerApiCalls['listGroupMembers'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
//# sourceMappingURL=group_service_client.js.map