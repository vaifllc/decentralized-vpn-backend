...
exports.ServiceMonitoringServiceClient = void 0;
/* global window */
...
class ServiceMonitoringServiceClient {
    ...
    constructor(opts) {
        ...
        this.descriptors.page = {
            ...
            listServiceLevelObjectives: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'serviceLevelObjectives'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.monitoring.v3.ServiceMonitoringService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.serviceMonitoringServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.monitoring.v3.ServiceMonitoringService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.monitoring.v3.ServiceMonitoringService, this._opts);
        ...
        for (const methodName of serviceMonitoringServiceStubMethods) {
            const callPromise = this.serviceMonitoringServiceStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    createServiceLevelObjective(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    getServiceLevelObjective(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    updateServiceLevelObjective(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    deleteServiceLevelObjective(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   for more details and examples.
     */
    listServiceLevelObjectives(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listServiceLevelObjectivesStream(request, options) {
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this.descriptors.page.listServiceLevelObjectives.createStream(this.innerApiCalls.listServiceLevelObjectives, request, callSettings);
    }
    /**
    ...
    listServiceLevelObjectivesAsync(request, options) {
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this.descriptors.page.listServiceLevelObjectives.asyncIterate(this.innerApiCalls['listServiceLevelObjectives'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.ServiceMonitoringServiceClient = ServiceMonitoringServiceClient;
//# sourceMappingURL=service_monitoring_service_client.js.map