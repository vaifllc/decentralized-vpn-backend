 ...
 * @memberof v3
 */
export declare class AlertPolicyServiceClient {
    private _terminated;
    private _opts;
    private _gaxModule;
    private _gaxGrpc;
    ...
    listAlertPolicies(request: protos.google.monitoring.v3.IListAlertPoliciesRequest, callback: PaginationCallback<protos.google.monitoring.v3.IListAlertPoliciesRequest, protos.google.monitoring.v3.IListAlertPoliciesResponse | null | undefined, protos.google.monitoring.v3.IAlertPolicy>): void;
    /**
     ...
     */
    listAlertPoliciesStream(request?: protos.google.monitoring.v3.IListAlertPoliciesRequest, options?: CallOptions): Transform;
    /**
     ...
     * }
     */
    listAlertPoliciesAsync(request?: protos.google.monitoring.v3.IListAlertPoliciesRequest, options?: CallOptions): AsyncIterable<protos.google.monitoring.v3.IAlertPolicy>;
    /**
